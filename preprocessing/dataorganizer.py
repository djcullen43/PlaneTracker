"""
Airplane Detection Project - Data Organizer
Author: Donovan Cullen
Description: This script organizes the image data into training, validation, and test sets based on
specified split ratios. It ensures that each class has a directory structure compatible with YOLO training.
"""
...
dataset_dir = r'C:Users\43lio\PyCharmProjects\TargeTracker\dataset'
