"""
Airplane Detection Project - YOLO Dataset Class ID Updater
Author: Donovan Cullen
Description: This script iterates over the label files in the dataset and updates the class IDs to ensure
they are compatible with YOLO training. It ensures that all labels are in the correct format and class ID.
"""
